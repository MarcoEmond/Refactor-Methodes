...
public class Main {
    public static void main(String[] args) {
        ...
        Ship ship = new Ship("YT-2400-77", "Light Freighter", 2500, Permissions.VIEW_MANIFEST | Permissions.EDIT_MANIFEST | Permissions.CARRY_HAZARDOUS);
        ...
        System.out.println(service.NotifyShipmentTotal(shipment));
    }
}
